...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/" class="brand-link">
      ...
      <span class="brand-text font-weight-light">CensoWeb</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <img src="images/banner.png" style="height: 75px; border-radius: 15px;">
    <!-- /.sidebar -->
  </aside>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023-2024 <a href="#">CensoWeb</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
